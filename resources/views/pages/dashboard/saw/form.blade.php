            ...
            <div class="card bg-gradient-primary shadow-lg mb-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="text-white mb-1">📊 Metode SAW (Simple Additive Weighting)</h2>
                            <p class="text-white opacity-8 mb-0">Sistem Pendukung Keputusan Pemilihan Alternatif Terbaik</p>
                        </div>
                        <div class="bg-white rounded-circle p-3 shadow">
                            <i class="fas fa-calculator text-primary fs-2"></i>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        @foreach ($kriteria as $index => $k)
                            <div class="mb-4 pb-3 border-bottom">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <span class="badge bg-{{ $k['atribut'] == 'benefit' ? 'success' : 'danger' }} ms-auto">

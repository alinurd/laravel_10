  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function tambahBaris() {
      ...
      row.innerHTML = ` 
        <td><input name="SubKriteria[nama][]" type="text" class="form-control" placeholder="Nama Subkriteria">
  <div id="${index}" class="form-text text-warning">
    <i>contoh: Tampilan antarmuka tidak intuitif</i>
  </div>
</td>
<td><input name="SubKriteria[ket][]" type="text" class="form-control" placeholder="Keterangan">
  <div id="${index}" class="form-text text-warning">
    <i>contoh: Sulit</i>
  </div>
</td>
<td><input name="SubKriteria[nilai][]" type="number" class="form-control" placeholder="Nilai">
  <div id="${index}" class="form-text text-warning">
    <i>contoh: 1</i>
  </div>
</td>
